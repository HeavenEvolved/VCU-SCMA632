...
def multivariate_comparison(data, target_col):
    ...
    with st.spinner("Running multivariate models..."):
        ...
        fig.update_layout(legend=dict(bgcolor='rgba(0, 0, 0, 0)'), title="Multivariate Forecast Comparison (Test Window)", xaxis_title="Date", yaxis_title=target_col, template="plotly_dark")
